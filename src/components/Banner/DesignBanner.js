...
const DesignBanner = () => {
    return(
        <section className="seo_home_area">
            ...
            <div className="banner_top" style={{backgroundImage: `url(${BannerBackground})`,
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 text-center seo_banner_content">
                            <Reveal effect="fadeInUp" duration={500}><h2>Orange Travel Assist</h2></Reveal>
                            <Reveal effect="fadeInUp" duration={1000}><p className="wow fadeInUp" data-wow-delay="0.5s">Donde quiera que viaje, estaremos ahi</p></Reveal>
