                ...
                <nav className={`navbar navbar-expand-lg menu_one ${mClass}`}>
                    <div className={`container ${cClass}`}>
                        <Link className={`navbar-brand ${slogo}`} to="/">
                            <img src={require("../img/orangeMini.png")} height={50} alt=""/>
                            <img src={require("../img/orangeMini.png")} height={50} alt="logo"/>
                        </Link>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className={`navbar-nav menu ml-auto ${nClass}`}>
                                ...
                                <li className="dropdown submenu nav-item">
                                    <Link to="./" title="Pages" className="dropdown-toggle nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Condiciones</Link>
                                    <ul role="menu" className=" dropdown-menu">
                                        <li className="nav-item"><NavLink exact title="Service Details" className="nav-link" to='/Condicionado'>Condicionado</NavLink></li>
                                        <li className="nav-item"><NavLink exact title="Service Details" className="nav-link" to='/CondicionesWeb'>Condiciones Web</NavLink></li>
                                        <li className="nav-item"><NavLink exact title="Service Details" className="nav-link" to='/Privacidad'>Privacidad</NavLink></li>
                                    </ul>
                                </li>
                                {/*<li className="dropdown submenu nav-item">
                                ...
                                <li className="nav-item dropdown submenu">
                                    ...
                                    <ul className="dropdown-menu">
                                        <li className="nav-item"><NavLink to="/Cotizador" className="nav-link">Cotizar Plan</NavLink></li>
                                        <li className="nav-item"><NavLink to="/Consultar" className="nav-link">Consultar Plan</NavLink></li>
                                    
                                    </ul>
                                </li>
                                <li className="nav-item"><NavLink title="Pricing" className="nav-link" to="/Enmergencias">Enmergencias</NavLink></li>
